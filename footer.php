...
<footer>
	...
	<div class="copyright span6">
		<img src="/wp-content/themes/WordPress_e-Teacher_2.0/e-Teacher/assets/images/logo-footer.png"><br />
		&copy; 
        ...
        <span><a href="http://www.on-lingua.com" alt="e-Teacher">e-Teacher</a></span>
	</div><!--End copyright-->
...
*********************************************************************** -->
<script src="<?php echo home_url( '/' ) ?>/wp-content/themes/WordPress_e-Teacher_2.0/e-Teacher/assets/js/bootstrap-collapse-min.js"></script>
<script src="<?php echo home_url( '/' ) ?>/wp-content/themes/WordPress_e-Teacher_2.0/e-Teacher/assets/js/bootstrap-transition-min.js"></script>
<script src="<?php echo home_url( '/' ) ?>/wp-content/themes/WordPress_e-Teacher_2.0/e-Teacher/assets/js/bootstrap-modal-min.js"></script>
<script src="<?php echo home_url( '/' ) ?>/wp-content/themes/WordPress_e-Teacher_2.0/e-Teacher/assets/js/bootstrap-dropdown-min.js"></script>
<script src="<?php echo home_url( '/' ) ?>/wp-content/themes/WordPress_e-Teacher_2.0/e-Teacher/assets/js/bootstrap-dropdown-toggle-min.js"></script>
