...
$themename = "E-Teacher Theme Options";
$shortname = "nt";
...
array( "name" => "Enter Map Title",
	...
	"type" => "text",
	"std" => "Visit Our School"), 
array( "name" => "Google Map URL",
	"desc" => "Enter the Google Maps link to your logo school for a map to be displayed on the homepage.",
