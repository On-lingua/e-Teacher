...
<head>
    ...
    <meta name="author" content="My language Skill">
    ...
    <!-- Fav and Touch Icons -->
    <link rel="shortcut icon" href="/wp-content/themes/WordPress_e-Teacher_2.0/e-Teacher/assets/images/favicon.ico">
    <link rel="apple-touch-icon" href="/wp-content/themes/WordPress_e-Teacher_2.0/e-Teacher/assets/images/apple-touch-icon.png">
    <link rel="apple-touch-icon" sizes="72x72" href="/wp-content/themes/WordPress_e-Teacher_2.0/e-Teacher/assets/images/apple-touch-icon-72x72.png">
    <link rel="apple-touch-icon" sizes="114x114" href="/wp-content/themes/WordPress_e-Teacher_2.0/e-Teacher/assets/images/apple-touch-icon-114x114.png">
    
    <!-- Modernizr -->
    <script src="<?php echo home_url( '/' ) ?>/wp-content/themes/WordPress_e-Teacher_2.0/e-Teacher/assets/js/modernizr.custom-min.js"></script>
...
<header class="row">
	...
	<div class="slogan span6">
		To know is to know that you know nothing. That is the meaning of true knowledge!.<br />
