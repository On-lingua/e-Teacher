...
<div class="row">
	<section id="courses" class="span11 pull-left">
		<div class="row">
			<h1 class="span6">Courses</h1>
			<nav class="courses span3 pull-right offset2">
				<?php
					$taxonomy     = 'topics';
					$orderby      = 'name'; 
    ...
    <hr />
		...
		$args = array_merge( $wp_query->query, array( 'post_type' => 'courses', 'showposts' => 6 ) );
